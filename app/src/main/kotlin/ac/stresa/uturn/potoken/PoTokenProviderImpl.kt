...
object PoTokenProviderImpl : PoTokenProvider {
    ...
    fun supportsWebView(): Boolean {
        try {
            ...
            Log.e("DeviceUtils", "webview not supported", ignored)
            return false
        }
    }
    ...
    override fun getWebClientPoToken(videoId: String): PoTokenResult? {
        ...
        try { return getWebClientPoToken(videoId = videoId, forceRecreate = false)
            ...
            synchronized(WebPoTokenGenLock) {
                ...
                if (shouldRecreate) {
                    ...
                    webPoTokenVisitorData = YoutubeParsingHelper.getVisitorDataFromInnertube(
                        ...
                        YoutubeParsingHelper.getYouTubeHeaders().toMutableMap(),
                    ...
                    webPoTokenGenerator = PoTokenWebView.newPoTokenGenerator(getAppContext()).blockingGet()

                    // The streaming poToken needs to be generated exactly once before generating
                    // any other (player) tokens.
                    webPoTokenStreamingPot = webPoTokenGenerator!!.generatePoToken(webPoTokenVisitorData!!).blockingGet()
                }

                return@synchronized Quadruple(webPoTokenGenerator!!, webPoTokenVisitorData!!, webPoTokenStreamingPot!!, shouldRecreate)
            }
